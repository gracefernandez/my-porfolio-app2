...
import logo from "../assets/img/codelogo.jpg";
  ...
  useEffect(() => {
    const onScroll = () => {
      if (window.scrollY > 50) {
        setScrolled(true);
        // document.getElementById("navbar-auto").style.color = "black"; 
        setScrolled(false);
        // document.getElementById("navbar-auto").style.color = ""; 
      }
    };
    ...
    <Container>
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="me-auto" id="navbar-auto">
          ...
          <Nav.Link href="#skills"  className={activeLink === 'skills'? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('homskie')}>Skills</Nav.Link>
